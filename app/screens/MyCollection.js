  ...
  const getFilteredFragrances = () => {
    return fragrances.filter((fragrance) => {
      const matchesTopFilter =
        ...
        (selectedTopFilter === "Owned" && fragrance.status === "Owned") ||
        (selectedTopFilter === "Not Owned" && fragrance.status === "Not Owned") ||
        (selectedTopFilter === "Favorited" && fragrance.favorited);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.tabs}>
          {["All", "Owned", "Not Owned", "Favorited"].map((filter, index) => (
            <TouchableOpacity
              key={index}
              style={[
                styles.tab,
