  	...
  	return (
    		<View style={styles.iphone1415ProMax4}>
      			...
      			<View style={[styles.topAppBar, styles.levelsFlexBox]}>
        				...
        				<Text style={styles.headline}>Privacy and Security</Text>
        				<View style={styles.leadingIcon}>
          					<View style={[styles.container, styles.containerLayout]}>
            						<View style={[styles.stateLayer, styles.levelsFlexBox]}>
              							<Image style={styles.icon} resizeMode="cover" source="Icon.png" />
      			...
      			<Text style={[styles.privacy, styles.titleFlexBox]}>Privacy:</Text>
      			<Text style={[styles.security, styles.titleFlexBox]}>
        				<Text style={styles.privacyTypo}>Security</Text>
        				...
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Two-Factor Authentication (2FA)</Text>
            						</View>
      			...
      			<View style={[styles.row1, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Device Management</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing, styles.contentsFlexBox]}>
                								<View style={styles.drillIn}>
      			...
      			<View style={[styles.row2, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Profile Visibility</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing2, styles.contentsFlexBox]}>
      			...
      			<View style={[styles.row3, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Location Preferences</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing, styles.contentsFlexBox]}>
                								<View style={styles.drillIn}>
      			...
      			<View style={[styles.row4, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Activity Status</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing, styles.contentsFlexBox]}>
                								<View style={styles.drillIn}>
      			...
      			<View style={[styles.row5, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Login Activity</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing2, styles.contentsFlexBox]}>
                								<View style={styles.info}>
      			...
      			<View style={[styles.row6, styles.rowBorder]}>
        				<View style={[styles.contents, styles.contentsLayout]}>
          					<View style={[styles.titleAndTrailingAccessories, styles.levelsFlexBox]}>
            						<View style={[styles.titleAndDetail, styles.contentsLayout]}>
              							<Text style={[styles.title, styles.titleLayout]} numberOfLines={1}>Recovery Email / Phone Number</Text>
            						</View>
            						<View style={[styles.accessoriesAndGrabber, styles.contentsFlexBox]}>
              							<View style={[styles.contentsTrailing, styles.contentsFlexBox]}>
                								<View style={styles.drillIn}>
